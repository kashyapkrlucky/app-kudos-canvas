export const textTheme = "text-purple-500";
export const bgTheme = "bg-purple-500";
export const borderTheme = "border-purple-500";
export const container = "mx-auto p-4";
export const cards = "bg-white shadow-md rounded-md p-4";
export const cardHeader = "bg-white shadow-md rounded-md p-4";
